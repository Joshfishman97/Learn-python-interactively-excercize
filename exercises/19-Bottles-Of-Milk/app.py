    ...
    def number_of_bottles():
        for i in range(99,1,-1):
            print(f'''{num} bottles of milk on the wall, {num} bottles of milk. {num} bottles of milk on the wall, {num} bottles of milk. Take one down and pass it around, {num-1} bottles of milk on the wall.''')
